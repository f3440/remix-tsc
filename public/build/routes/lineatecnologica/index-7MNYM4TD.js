import {
  Link
} from "/build/_shared/chunk-YH5ICZOI.js";
import {
  React,
  init_react
} from "/build/_shared/chunk-DNEVBLEG.js";

// browser-route-module:F:\Ferro\Projects\remix-tsc\app\routes\lineatecnologica\index.tsx?browser
init_react();

// app/routes/lineatecnologica/index.tsx
init_react();
var meta = () => {
  return {
...
function Index() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("main", null, /* @__PURE__ */ React.createElement("div", {
    ...
    className: "font-alt"
  }, "SALUD Y BIENESTAR"), /* @__PURE__ */ React.createElement("p", null, "Productos para salud."), /* @__PURE__ */ React.createElement(Link, {
    ...
    className: "font-alt"
  }, "SOFTWARE Y TECNOLOGIA"), /* @__PURE__ */ React.createElement("p", null, "Para ti y tu empresa"), /* @__PURE__ */ React.createElement(Link, {
    className: "btn btn-border-d btn-circle",
    to: "/lineasoftware/"
...
//# sourceMappingURL=/build/routes/lineatecnologica/index-7MNYM4TD.js.map
