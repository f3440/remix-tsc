      ...
      <main>
        ...
        <section className="module pt-0 pb-0" id="about">
              ...
              <div className="col-sm-8">
                <form id="contactForm" role="form" method="post" action="php/contact.php">
                  <div className="form-group">
                    ...
                    <input className="form-control" type="text" id="name" name="name" placeholder="Tu Nombre*" required={true} data-validation-required-message="Please enter your name."/>
                    <p className="help-block text-danger"></p>
                  </div>
                  <div className="form-group">
                    <label className="sr-only" htmlFor="email">Email</label>
                    <input className="form-control" type="email" id="email" name="email" placeholder="Tu correo electronico*" required={true} data-validation-required-message="Please enter your email address."/>
                    <p className="help-block text-danger"></p>
                  </div>
                  <div className="form-group">
                    <textarea className="form-control" rows={7} id="message" name="message" placeholder="Tu mensaje*" required={true} data-validation-required-message="Please enter your message."></textarea>
                    <p className="help-block text-danger"></p>
                  </div>
          ...
          <section id="map-section">
            {/* <div id="map"></div> */}
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d956.3661661900794!2d-68.12282491699169!3d-16.50262294058292!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x915f21bd3024f007%3A0x2a74f58e90d5e125!2sTITIRILANDIA!5e0!3m2!1ses!2sbo!4v1658423715443!5m2!1ses!2sbo" width="100%" height="450" style={{'border':0}} allowFullScreen={true} loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
          </section>
